                ...
                <div class="cs-hobble">
                  <a href="#" class="cs-card cs-style1 cs-hover_layer1">
                    ...
                    <div class="cs-card_info">
                      ...
                      <h2 class="cs-card_title text-center">Website Development</h2>
                    </div>
                  </a>
                </div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="cs-hobble">
                  <a href="service-details.html" class="cs-card cs-style1 cs-hover_layer1">
                    ...
                    <div class="cs-card_info">
                      <span class="cs-hover_layer3 cs-accent_bg"></span>
                      <h2 class="cs-card_title text-center">App Development</h2>
                    </div>
                  </a>
                </div>
                <div class="cs-height_0 cs-height_lg_30"></div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 offset-xl-2">
            <img src="assets/img/About_img2.jpg" alt="" class="w-100 cs-radius_15">
...
<div class="container">
  <div class="row align-items-center">
    ...
    <div class="col-lg-6 offset-xl-1">
      <h2 class="cs-font_50 cs-m0">Our Technolgy, Your Growth Engine! </h2>
      ...
      <div class="container-fluid">
        <div class="cs-cta cs-style1 cs-bg text-center cs-shape_wrap_1 cs-position_1" data-src="assets/img/cta_bg.jpeg">
          ...
          <div class="cs-cta_in">
            ...
            <button type="button" class="thm-btn cta-one__btn" data-bs-toggle="modal" data-bs-target="#letstalk1" fdprocessedid="b7v46">
              Get Started
             </button>
          </div>
        </div>
      ...
      <div class="cs-fooer_main">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="cs-footer_item text-center">
...
<!-- Mirrored from arino-html.vercel.app/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Feb 2023 10:04:12 GMT -->
</html>